  ...
  return (
    <>
      ...
      <div className="flex sm:flex-col md:flex-row justify-evenly ml-4">
        ...
        <div className="bg-gray-200 rounded-md p-4 scroll-m-2 md:col-start-2 col-span-4 md:w-2/3  max-h-96 overflow-y-auto">
          <div>
            <p className='text-green-900 font-bold text-2xl'>Public routines</p>
