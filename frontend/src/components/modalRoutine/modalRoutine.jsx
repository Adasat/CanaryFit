          ...
          <div className="flex flex-row justify-between p-2">
            <div className="flex flex-col gap-3 ml-6">
              <p className="text-black">
                <b>Target:</b>{' '}
                <span className="ml-2 italic">{routine.routineTarget}</span>
              </p>
              <p className="text-black">
                <b>Style:</b>{' '}
                <span className="ml-2 italic">{routine.styleRoutine}</span>{' '}
              </p>
              {routine && routine.owner && (
                <p className="text-black">
                  <b>Owner:</b>{' '}
                  <span className="ml-2 italic">
                    {routine.owner.firstname} {routine.owner.lastname}
                  </span>
                </p>
              )}
              <p className="text-black">
                <b>Days per week:</b>{' '}
                <span className="ml-2 italic">{routine.dayPerWeek} days</span>
              </p>
              <p className="text-black">
                <b>Time:</b>{' '}
                <span className="ml-2 italic">
                  {routine.timeEstimate} minutes
                </span>
              </p>
            </div>
