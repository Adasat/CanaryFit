...
import { montse, montseBold } from '@/app/layout';
...
export default function SignupForm({
  ...
  return (
    <form className="flex flex-col justify-center items-center gap-3 p-4">
      <p
        className={`${montseBold.className} text-bold md:text-5xl text-center`}
      >
        Signup
      </p>
      <InputField
      ...
      <div className="flex flex-row space-x-4 justify-center">
        <div className="flex flex-col ">
          <label
            htmlFor="height"
            className={`${montse.className} text-center md:text-lg`}
          >
            Height:
          </label>
          <input
        ...
        <div className="flex flex-col">
          <label
            htmlFor="weight"
            class={`${montse.className} text-center md:text-lg`}
          >
            Weight:
          </label>
          <input
      ...
      />
      <p className={`${montse.className} md:text-lg mt-2`}>
